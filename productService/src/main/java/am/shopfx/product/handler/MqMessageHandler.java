package am.shopfx.product.handler;
...
import am.shopfx.core.pojo.DeductionResult;
import am.shopfx.core.pojo.OrderMsg;
import am.shopfx.product.service.QuantityService;
...
public class MqMessageHandler {
    ...
    public DeductionResult deductQuantityHandle(OrderMsg msg, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long tag) throws IOException {
        ...
        DeductionResult result = new DeductionResult(msg.getOrderId(), true, "");
